...
participant ui1 as Trang thêm tài khoản
participant manage as Quản lí tài khoản
participant db as Tài khoản
autonumber


user->>+ui: Yêu cầu thêm tài khoản
activate user
activate ui
ui->>+ui1: Hiển thị giao diện
user->>+ui1: Nhập thông tin tài khoản
ui1->>+manage: Xử lí yêu cầu thêm tài khoản
activate manage
manage->>+db: Xử lí dữ liệu tài khoản
db->>-manage:Trả về kết quả
alt success
  manage-->>ui:Trả về thông báo thêm tài khoản thành công
else error
  manage-->>-ui:Trả về thông báo lỗi cụ thể khi thêm tài khoản
end
